 ...
 * @author ACER
 */
public class AccHolderFormController implements Initializable {
    ...
    void handleSaveButton(ActionEvent event) throws SQLException {
        ...
        try {
            ...
            btnadd.fire();
            lblsavestatus.setText("Berhasil Menambahkan Antrian");
        } catch (SQLException ex) {
            lblsavestatus.setText("Gagal Antri");
            Logger.getLogger(AccHolderFormController.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//            tfholderID1.setText(""+ahdm.nextID1());
            lblsavestatus1.setText("Berhasil Konfirmasi");
            btnadd1.fire();
        } catch (SQLException ex) {
            lblsavestatus1.setText("Gagal Konfirmasi");
            Logger.getLogger(AccHolderFormController.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ObservableList<String> jenjang = FXCollections.observableArrayList("Menikah","Belum Menikah","Cerai");
        cbJenjang.setItems(jenjang);
        ObservableList<String> pangkat = FXCollections.observableArrayList("Berhasil Rekam","Gagal Rekam");
